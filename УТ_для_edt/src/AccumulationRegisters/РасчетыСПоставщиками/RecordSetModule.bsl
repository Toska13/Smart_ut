...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	ВыборкаИзменениеВводОстатков = МассивРезультатов[2].Выбрать();
	ВыборкаИзменениеВводОстатков.Следующий();
	СтруктураВременныеТаблицы.Вставить("РасчетыСПоставщикамиИзмененияВводОстатков", ВыборкаИзменениеВводОстатков.Количество > 0);
	...
	//++ смарт закомментировно, т.к. при обмене РИБ ошибка
