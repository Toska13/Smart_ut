...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	ВыборкаИзменениеВводОстатков = МассивРезультатов[5].Выбрать();
	...
	СтруктураВременныеТаблицы.Вставить("РасчетыСКлиентамиИзмененияВводОстатков", ВыборкаИзменениеВводОстатков.Количество > 0);
