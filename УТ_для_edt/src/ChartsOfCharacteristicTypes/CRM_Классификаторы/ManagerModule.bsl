...
Функция ПолучитьРасписаниеВыполненияКлассификатора(Классификатор) Экспорт
	...
	РегламентноеЗаданиеОбъект = CRM_КлассификаторыЭкспортныеМетоды.НайтиРегламентноеЗадание(Классификатор.РегламентноеЗаданиеGUID);
...
Функция СоздатьРегламентноеЗаданиеПриНеобходимости(Отказ, ТекущийОбъект)
	...
	РегламентноеЗаданиеОбъект = CRM_КлассификаторыЭкспортныеМетоды.НайтиРегламентноеЗадание(ТекущийОбъект.РегламентноеЗаданиеGUID);
...
Функция АдресаСхемыКомпоновкиДанныхИНастроекВоВременномХранилище(ЭлементНастройки) Экспорт
	...
	НаборДанных.Запрос = CRM_КлассификаторыЭкспортныеМетоды.СформироватьТекстЗапросаПринадлежностиКлассификатора(ЭлементНастройки);
