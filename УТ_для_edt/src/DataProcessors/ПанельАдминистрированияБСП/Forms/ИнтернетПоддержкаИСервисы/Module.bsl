...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// +CRM Размещать в конце метода
	ЭлементВыбора = Элементы.ЦентрМониторингаРазрешитьОтправлятьДанные.СписокВыбора.Получить(0);
	ЭлементВыбора.Представление = СтрЗаменить(ЭлементВыбора.Представление,
										 НСтр("ru = '1С';en = '1C'" ), НСтр("ru = '1С-Рарус';en = '1C-Rarus'" ));
 	// -CRM
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если (РеквизитПутьКДанным = "НаборКонстант.ИспользоватьОнлайнПоддержку" Или РеквизитПутьКДанным = "")
		...
		Элементы.ГруппаНастройкаОнлайнПоддержки.Доступность = НаборКонстант.ИспользоватьКоннект;
	КонецЕсли;
