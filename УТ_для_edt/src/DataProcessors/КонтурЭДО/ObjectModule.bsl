...
Функция КлючРазработчика()
	...
	Возврат "1C-DDPro-4-59-1-1ef68338-3a7a-40b0-be71-b27a8db491f2";
...
Функция Зависимости() Экспорт
	...
	МодульМенеджерКриптографии = Новый_Зависимость("МенеджерКриптографии",
			МакетыОбработки.КонтурДиадокМенеджерКриптографии.Имя);
	МодульАвторизатор = Новый_Зависимость("ПортальнаяАвторизацияАвторизатор",
			МакетыОбработки.КонтурДиадокПортальнаяАвторизацияАвторизатор.Имя);
	МодульАутентификатор = Новый_Зависимость("Аутентификатор",
			МакетыОбработки.КонтурДиадокАутентификатор.Имя);
	МодульАутентификаторХранилище = Новый_Зависимость("АутентификаторХранилище",
			МакетыОбработки.КонтурДиадокАутентификаторХранилище.Имя);
	
	Зависимости = Новый Массив;
	Зависимости.Добавить(МодульСтд);
	Зависимости.Добавить(МодульСтдДиалоги);
	...
	Зависимости.Добавить(МодульАвторизатор);
	Зависимости.Добавить(МодульАутентификатор);
	Зависимости.Добавить(МодульАутентификаторХранилище);
...
// ПодключитьЗависимостиБезопасно
...
// ДобавитьПодключенныеМетаданные
...
// ПодключитьОбработкуТолстыйКлиентОП
...
Функция Перечисление_МодулиБиблиотек()
	...
	Результат = Новый Структура;
	Результат.Вставить("КонтурДиадокСтдДиалоги", "КонтурДиадокСтдДиалоги");
	...
	Результат.Вставить("КонтурДиадокМетрики", "КонтурДиадокМетрики");
