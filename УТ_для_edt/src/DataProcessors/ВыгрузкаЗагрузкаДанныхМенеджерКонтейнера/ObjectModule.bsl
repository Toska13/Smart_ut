...
Процедура ЗаписатьИнформациюОРасширениях()
	...
	Для Каждого РасширениеКонфигурации Из РасширенияКонфигурации.Получить() Цикл
		...
		Если РазделениеВключено Тогда
			...
			ПоставляемоеРасширение = РасширенияВМоделиСервиса.ПоставляемоеРасширение(
				РасширениеКонфигурации.УникальныйИдентификатор);
				
		Иначе
			ПоставляемоеРасширение = Неопределено;
		КонецЕсли;
		...
		Если ЗначениеЗаполнено(ПоставляемоеРасширение) Тогда
			...
			РеквизитыПоставляемогоРасширения = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ПоставляемоеРасширение,
				"ИдентификаторВерсии, Наименование");
			...
			ЗаписьПоставляемыхРасширений.ЗаписатьАтрибут("ModifiesDataStructure", Формат(ИзменяетСтруктуруДанных,
				"БЛ=false; БИ=true"));
			ЗаписьПоставляемыхРасширений.ЗаписатьАтрибут("Name", Строка(РеквизитыПоставляемогоРасширения.Наименование));
			ЗаписьПоставляемыхРасширений.ЗаписатьАтрибут("VersionUUID", Строка(
				РеквизитыПоставляемогоРасширения.ИдентификаторВерсии));
