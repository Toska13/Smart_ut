...
// +CRM
	CRM_МетодыФормОбработокСервер.ДобавитьКомандыЗагрузкиРезультатаОтчета(ЭтотОбъект);
// -CRM
...
// +CRM
&НаКлиенте
Процедура Подключаемый_CRM_ЗагрузитьИзРезультатаОтчета(Команда)
	CRM_МетодыФормОбработокКлиент.ЗагрузитьИзРезультатаОтчета(ЭтотОбъект);
КонецПроцедуры
// -CRM
