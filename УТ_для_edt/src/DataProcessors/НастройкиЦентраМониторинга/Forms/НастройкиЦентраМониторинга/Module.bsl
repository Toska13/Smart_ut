...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ОтправлятьИнформациюОбОшибках.РасширеннаяПодсказка.Заголовок = 
		СтрЗаменить(Элементы.ОтправлятьИнформациюОбОшибках.РасширеннаяПодсказка.Заголовок,
