...
Процедура КонвертироватьНаСервере()
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		Если Событие.Товары.Количество() > 0 Тогда
			...
			ДокументКП.УдалитьСоглашение		= Событие.Соглашение;
			...
			ДокументКП.Клиент					= Событие.Партнер;
			Если ЗначениеЗаполнено(ДокументКП.УдалитьСоглашение) Тогда
				ДокументКП.Валюта				= ДокументКП.УдалитьСоглашение.Валюта;
			КонецЕсли;
				...
				Если ТипЗнч(ДокументБП) = Тип("ДокументСсылка.УдалитьCRM_Событие") Тогда
					...
					Если ДокументБП.Товары.Количество() > 0 Тогда
						...
						Если ТекущееКП = Неопределено Тогда
							...
							ДокументКП.УдалитьСоглашение		= ДокументБП.Соглашение;
							...
							ДокументКП.Клиент					= ДокументБП.Партнер;
							Если ЗначениеЗаполнено(ДокументКП.УдалитьСоглашение) Тогда
								ДокументКП.Валюта				= ДокументКП.УдалитьСоглашение.Валюта;
							КонецЕсли;
