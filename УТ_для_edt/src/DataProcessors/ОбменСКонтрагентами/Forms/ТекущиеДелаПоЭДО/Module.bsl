...
//   ** Поле - Строка - путАь к данным, на которые устанавливается отбор. Должно начинаться с "ЭлектронныйДокумент".
//		Примеры: "ЭлектронныйДокумент", "ЭлектронныйДокумент.СодержитДанныеОМаркируемыхТоварах"
//   ** ВидСравнения - ВидСравненияКомпоновкиДанных - вид сравнения отбора.
//   ** Значение - Произвольный - значение отбора.
//  
...
Процедура СформироватьЭД(Команда)
	...
	Если Элементы.СформироватьЭД.ТекущиеДанные <> Неопределено Тогда
		ОбменСКонтрагентамиСлужебныйКлиент.ОткрытьАктуальныйЭД(Элементы.СформироватьЭД.ТекущиеДанные.Документ);
	КонецЕсли;
...
Процедура ОтправитьПакеты(Команда)
	...
	ОбменСКонтрагентамиСлужебныйКлиент.ОтправитьМассивПакетовЭД(Элементы.ПакетыЭД.ВыделенныеСтроки);
...
Процедура ОтклонитьДокумент(Команда)
	...
	МассивСсылок = ДанныеВыделенныхСтрокРаздела(ТекущийРаздел, "Ссылка");
	ОбменСКонтрагентамиСлужебныйКлиент.ОбработатьОтклонениеАннулированиеЭД(МассивСсылок, Истина);
...
Процедура СоздатьОтборПоРазделу(Знач Раздел, Знач НастройкиОтображения, ГруппаОтбора)
	...
	Если Раздел = "Входящие" Тогда
		...
		Значение.Добавить(ПредопределенноеЗначение("Перечисление.ТипыЭлементовВерсииЭД.СвРКУПД"));
		Значение.Добавить(ПредопределенноеЗначение("Перечисление.ТипыЭлементовВерсииЭД.СвЗКУПД"));
		Значение.Добавить(ПредопределенноеЗначение("Перечисление.ТипыЭлементовВерсииЭД.СвИСРКУПД"));
		Значение.Добавить(ПредопределенноеЗначение("Перечисление.ТипыЭлементовВерсииЭД.СвИСЗКУПД"));
...
Процедура ПоказатьКомандыРаздела(Знач Раздел)
	...
	КомандыРазделов.Вставить("Исходящие", "Обновить, ЗакрытьПринудительно, Перенаправить, УтвердитьПодписатьИОтправитьИсх, КомандыИсходящиеЭД, СоздатьПроизвольныйДокумент");
...
Функция ЭтоИзвещениеПодтверждение(Знач ТипЭД)
	...
	СлужебныеТипыЭД.Добавить(Перечисления.ТипыЭлементовВерсииЭД.ИП_ПДП_ИП_УПД_УКД);
	СлужебныеТипыЭД.Добавить(Перечисления.ТипыЭлементовВерсииЭД.ИП_ПДП_ИП_ЭСФ);
	...
	СлужебныеТипыЭД.Добавить(Перечисления.ТипыЭлементовВерсииЭД.ПДП_ИП_УПД_УКД);
	СлужебныеТипыЭД.Добавить(Перечисления.ТипыЭлементовВерсииЭД.ПДП_ИП_ЭСФ);
