...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли ИмяСобытия = "Запись_Файл" Тогда
		...
		Если Параметр.Свойство("ЭтоНовый") И Параметр.ЭтоНовый Тогда
			...
			// +CRM
			Если Не Параметры.CRM_НеЗапрашиватьКонтекст Тогда
...
Процедура НастроитьДинамическийСписок(ИмяСправочникаХранилищаФайлов, Знач ЕстьРеквизитСлужебный = Ложь)
	...
	// +CRM
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&ВариантКонтекстаФайла", 
					?(ИмяСправочникаХранилищаФайлов = "CRM_ЭтапКалендарногоПланаПрисоединенныеФайлы", 
						"Файлы.CRM_ВариантКонтекстаФайла КАК ВариантКонтекстаФайла", "ЛОЖЬ"));
	// -CRM
