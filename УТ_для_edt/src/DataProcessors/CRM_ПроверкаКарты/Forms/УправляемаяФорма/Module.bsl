...
&НаКлиенте
Процедура ОтрисоватьНедопустимуюВходящуюТочкуУсловиВыбораВарианта(ТекущийЭлементКоллекции,ПервыйВход = Ложь)
...
&НаКлиенте
Процедура ОтрисоватьПутьНеДолжноВестиКСлиянию(ТекущийЭлементКоллекции, ПервыйВход = Ложь)
	#Если НЕ МобильныйКлиент Тогда
	Попытка
...
&НаКлиенте
Процедура ОтрисоватьПутьКОшибочномуСлиянию(ТекущийЭлементКоллекции,Разделение, ПервыйВход = Ложь);
	#Если НЕ МобильныйКлиент Тогда
	Попытка
	Если ПервыйВход Тогда
...
&НаКлиенте
Процедура ОтрисоватьПутьЗаПределыРазделенияКЗавршению(ТекущийЭлементКоллекции, ПервыйВход = Ложь)
	#Если НЕ МобильныйКлиент Тогда
	Попытка
	МассивСтрок = ИндексыЭлементов.НайтиСтроки(Новый Структура("Имя",ТекущийЭлементКоллекции.ИмяЭлемента));
...
&НаКлиенте
Процедура ОтрисоватьВыходЗаПределыРазделения(ТекущийЭлементКоллекции, Разделение, ПервыйВход = Ложь)
	#Если НЕ МобильныйКлиент Тогда
	Попытка
	МассивСтрок = ИндексыЭлементов.НайтиСтроки(Новый Структура("Имя",ТекущийЭлементКоллекции.ИмяЭлемента));
...
&НаКлиенте
Процедура ОтрисоватьВеткуБезТочекДействия(ТекущийЭлементКоллекции, ПервыйВход = Ложь)
	#Если НЕ МобильныйКлиент Тогда
	Попытка
	МассивСтрок = ИндексыЭлементов.НайтиСтроки(Новый Структура("Имя",ТекущийЭлементКоллекции.ИмяЭлемента));
...
&НаКлиенте
Процедура ОтрисоватьПутьОтЭлемента(ТекущийЭлементКоллекции, ПервыйВход = Ложь)
	#Если НЕ МобильныйКлиент Тогда
	Попытка
	МассивСтрок = ИндексыЭлементов.НайтиСтроки(Новый Структура("Имя",ТекущийЭлементКоллекции.ИмяЭлемента));
...
&НаКлиенте
Процедура ОтрисоватьОшибкуПервичнойПроверки(ТекущийЭлементКоллекции)
	#Если НЕ МобильныйКлиент Тогда
	Попытка
	МассивСтрок = ИндексыЭлементов.НайтиСтроки(Новый Структура("Имя",ТекущийЭлементКоллекции.ИмяЭлемента));
...
&НаКлиенте
Процедура ОтрисоватьИзбыточнуюВетку(ТекущийЭлементКоллекции)
	#Если НЕ МобильныйКлиент Тогда
	Попытка
	МассивСтрок = ИндексыЭлементов.НайтиСтроки(Новый Структура("Имя",ТекущийЭлементКоллекции.ИмяЭлемента));
