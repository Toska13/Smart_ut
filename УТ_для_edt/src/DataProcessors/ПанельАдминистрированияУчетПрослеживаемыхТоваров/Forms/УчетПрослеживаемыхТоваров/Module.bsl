...
Процедура ДекорацияОформитьОтчетыНажатие(Элемент)
	...
	ОткрытьФорму(
		"ЖурналДокументов.ОтчетыКомиссионеров.Форма.ФормаСпискаДокументов",ПараметрыОткрытия,
		ЭтаФорма,,,,,
		РежимОткрытияОкнаФормы.Независимый);
...
Процедура ДекорацияОткрытьСписокОтчетовНажатие(Элемент)
	...
	ИмяОткрываемойФормы = "ЖурналДокументов.ОтчетыКомиссионеров.Форма.ФормаСпискаДокументов";
...
Процедура ДекорацияОткрытьСписокВозвратыНажатие(Элемент)
	...
	ПараметрыВыбора = Новый Структура("Отбор", ОтборСписокВозвратовОтКомиссионера());
...
Процедура ДекорацияОткрытьСписокПередачКомиссионерамНажатие(Элемент)
	...
	ПараметрыВыбора = Новый Структура("Отбор", ОтборСписокПередачНаКомиссию());
...
Процедура ДекорацияОткрытьСписокОтчетовКомитентамНажатие(Элемент)
	...
	ИмяОткрываемойФормы = "ЖурналДокументов.ОтчетыКомитентам.Форма.ФормаСпискаДокументов";
...
Процедура ДекорацияОткрытьСписокВозвратовИПриемовНажатие(Элемент)
	...
	СписокХозяйственныхОпераций.Добавить(ПредопределенноеЗначение("Перечисление.ХозяйственныеОперации.ВозвратТоваровКомитенту"));
	СписокХозяйственныхОпераций.Добавить(ПредопределенноеЗначение("Перечисление.ХозяйственныеОперации.ПриемНаКомиссию"));
	
	ЭлементОтбор = НастройкиОтбора.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ЭлементОтбор.ЛевоеЗначение  = Новый ПолеКомпоновкиДанных("ХозяйственнаяОперация");
	ЭлементОтбор.ВидСравнения   = ВидСравненияКомпоновкиДанных.ВСписке;
	ЭлементОтбор.ПравоеЗначение = СписокХозяйственныхОпераций;
	ЭлементОтбор.Использование  = Истина;
	
	ИмяОткрываемойФормы = "Обработка.ЖурналДокументовЗакупки.Форма.СписокДокументов";
	ПараметрыОткрытия = Новый Структура;
	
	ОткрытьФормуСОтборомПоПериоду(ИмяОткрываемойФормы, ПараметрыОткрытия, НастройкиОтбора);
...
Процедура УстановитьВидимостьЭлементов()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, 
		...
		"Видимость", 
		ПравоДоступа("Просмотр", Метаданные.ЖурналыДокументов.ОтчетыКомитентам));
	...
	ПравоДоступаОтчетыКомиссионеров = ПравоДоступа("Просмотр", Метаданные.ЖурналыДокументов.ОтчетыКомиссионеров);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы,
...
Функция ОтборСписокВозвратовОтКомиссионера()
	...
	Структура = Новый Структура;
	Структура.Вставить("ХозяйственнаяОперация", Перечисления.ХозяйственныеОперации.ВозвратОтКомиссионера);
