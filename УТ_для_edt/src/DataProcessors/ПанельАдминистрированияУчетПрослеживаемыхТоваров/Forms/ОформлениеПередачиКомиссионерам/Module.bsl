...
Процедура СоздатьДокументРеализацияТоваров(Организация, Комиссионер, Соглашение, ДокументВозврат)
	...
	ДокументРеализация.ДатаРаспоряжения         = КонецДня(ТекущаяДатаСеанса());
	...
	Иначе
		ТекстСообщения = НСтр("ru = 'Документ не проведен: " + Строка(ДокументРеализация) + ".';
							|en = ''");
...
Процедура СформироватьВсеДокументыПередачи()
	...
	Для Каждого Строка Из КОформлениюПередач Цикл
		...
		Если Строка.Передача Тогда
			ТекстСообщения = НСтр("ru = 'Для документа:  " + Строка(Строка.Возврат) + " передача уже оформлена.';
			|en = ''");
		...
		Исключение
			ТекстСообщения = НСтр("ru = 'Не удалось создать документ реализация.';
									|en = 'Не удалось создать документ реализация.'");
...
Процедура СформироватьВыделенныеДокументыПередачи()
	...
	Для Каждого СтрокаИД Из Элементы.КОформлениюПередач.ВыделенныеСтроки Цикл
		...
		Исключение
			ТекстСообщения = НСтр("ru = 'Не удалось создать документ возврата.';
									|en = 'Не удалось создать документ возврата.'");
