...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаголовокЭлемента = СтрШаблон(Элементы.ДекорацияИнформация.Заголовок, ?(ПравоСозданияСклада,"или сгенерируйте новый",""));
...
Процедура СгенерироватьСкладНаСервере()
	...
	НовыйСклад.КонтролироватьОбеспечение         = Истина;
	НовыйСклад.Наименование                      = "Виртуальный склад прослеживаемых товаров";
	НовыйСклад.Записать();
