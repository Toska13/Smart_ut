...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заказы.ЗагрузитьЗначения(Параметры.Заказы.ВыгрузитьЗначения());
	СторнируемыеДокументы.ЗагрузитьЗначения(Параметры.СторнируемыеДокументы.ВыгрузитьЗначения());
	...
	Если Параметры.Свойство("ПараметрКоманды") Тогда
		Заказы.ЗагрузитьЗначения(Параметры.ПараметрКоманды);
	КонецЕсли;
...
Процедура ОбновитьСостояниеНаСервере()
	...
	ЭтоСостояниеОбеспеченияЗаказов = Не Параметры.ВызовИзФормыЗаказа И Заказы.Количество() = 0;
...
Функция СостояниеОбеспеченияЗаказов()
	...
	Если Параметры.ВызовИзФормыЗаказа Тогда
		...
		Документ.СторнируемыеДокументы = СторнируемыеДокументы.ВыгрузитьЗначения();
...
Процедура ВыполнитьОбеспечение(Источник, Заказ, Параметр, ЖелаемаяДатаОтгрузки, НеОтгружатьЧастями)
	...
	Если Заказ = Неопределено Тогда
		...
		РеквизитыЗаказа.Ссылка = СторнируемыеДокументы;
...
Процедура НастроитьЭлементыФормыПоПараметрам()
	...
	ЭтоСостояниеОбеспеченияЗаказов = Не Параметры.ВызовИзФормыЗаказа И Заказы.Количество() = 0;
	ЭтоСостояниеОбеспеченияВыделенныхЗаказов = Не Параметры.ВызовИзФормыЗаказа И Заказы.Количество() > 0;
...
Процедура СохранитьНастройкиКомпоновщика()
	Если НЕ Параметры.ВызовИзФормыЗаказа И Заказы.Количество() = 0 Тогда
