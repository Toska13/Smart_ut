...
Процедура УстановитьВидимостьДекорацияРегистрация();
	...
	ТребуетсяПодключение = БизнесСеть.ОрганизацияНеПодключенаТрубуетсяПовторноеПодключение(Организация);
...
Процедура СохранитьКонтактныеДанныеОрганизации()
	...
	Для каждого ЭлементКоллекции Из СтрокиАдресов Цикл
		...
		ДанныеАдреса = Новый Структура("КодСтраны, ИдентификаторФИАС, ЗначенияПолей, ПредставлениеАдреса", "", "", "", "");
