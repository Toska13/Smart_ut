...
Процедура ТаблицаДоступныхДействийТекущаяПодобратьКоличество(ИдентификаторТекущейСтроки)
	...
	Если ПодборТоваров И КоличествоПодобрать = 0 И Количество <> КоличествоПодобрано Тогда
	...
	ИдентификаторТекущейСтрокиТаблицаДоступныхДействийТекущая = Элементы.ТаблицаДоступныхДействийТекущая.ТекущаяСтрока;
