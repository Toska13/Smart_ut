...
Процедура АналитикаРасходовОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Если ТипЗнч(ВыбранноеЗначение) = Тип("Структура") Тогда
		Если Элемент = Элементы.ПрочиеРасходыКорАналитикаРасходов
		 ИЛИ Элемент = Элементы.КорАналитикаРасходов Тогда
			СтрокаТаблицы.КорАналитикаРасходов = ВыбранноеЗначение.АналитикаРасходов;
		Иначе 			
