...
Процедура ОтображениеГруппыНастройкиОтраженияВУчете()
	...
	СпрашиватьПроСохранениеНастроекУчета = ОбменСКонтрагентамиСлужебный.ПредложитьСохранитьНастройкуОтраженияВУчете(
		...
		ЭлектронныйДокумент.ВидЭД, ЭлектронныйДокумент.ПрикладнойВидЭД) И Не ОбменСКонтрагентамиСлужебный.ОтключенКонтрольОтраженияВУчетеВНастройках(ЭлектронныйДокумент.Ссылка);
