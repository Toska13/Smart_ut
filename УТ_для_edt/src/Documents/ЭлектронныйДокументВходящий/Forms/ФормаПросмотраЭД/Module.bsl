...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СпрашиватьПроСохранениеНастроекУчета = ОбменСКонтрагентамиСлужебный.ПредложитьСохранитьНастройкуОтраженияВУчете(
		...
		Объект.ВидЭД, Объект.ПрикладнойВидЭД) И Не ОбменСКонтрагентамиСлужебный.ОтключенКонтрольОтраженияВУчетеВНастройках(Объект.Ссылка);
...
Процедура ОткрытьСопоставлениеНоменклатуры()
	...
	Если ОтключенКонтрольОтраженияВУчетеВНастройках(Объект.Ссылка) Тогда
		НаборНоменклатурыКонтрагентов = ВыполнитьКонтрольСопоставленияНоменклатуры(Объект.Ссылка);
	Иначе
...
&НаСервереБезКонтекста
Функция ОтключенКонтрольОтраженияВУчетеВНастройках(ЭлектронныйДокумент)
	
	Возврат ОбменСКонтрагентамиСлужебный.ОтключенКонтрольОтраженияВУчетеВНастройках(ЭлектронныйДокумент); 
	
КонецФункции

&НаСервереБезКонтекста
Функция ВыполнитьКонтрольСопоставленияНоменклатуры(ЭлектронныйДокумент)
	
	Возврат ОбменСКонтрагентамиСлужебный.ВыполнитьКонтрольСопоставленияНоменклатуры(ЭлектронныйДокумент,, Ложь); 
...
&НаСервереБезКонтекста
Функция ТребуетсяСопоставлениеНоменклатурыДляДокументаСОтключеннымКонтролем(ЭлектронныйДокумент)
	
	Возврат ОтключенКонтрольОтраженияВУчетеВНастройках(ЭлектронныйДокумент) 
		И ВыполнитьКонтрольСопоставленияНоменклатуры(ЭлектронныйДокумент).Количество() > 0;
...
Процедура ОбработатьВыборСозданияДокументаУчета(ВыбранноеЗначение, ДополнительныеПараметры) Экспорт
	...
	Если ТребуетсяСопоставлениеНоменклатурыДляДокументаСОтключеннымКонтролем(Объект.Ссылка) Тогда
