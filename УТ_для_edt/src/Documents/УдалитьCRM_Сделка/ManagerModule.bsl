...
Функция ПолучитьДанныеОбъекта(СсылкаНаОбъект)
	...
	//	ДанныеОбъекта.Вставить("СтрокаНДС", НСтр("ru='Без налога (НДС)';en='Without tax (VAT)'"));
	//	ДанныеОбъекта.Вставить("ВсегоНДС", "-");
	//Иначе
	//	ДанныеОбъекта.Вставить("СтрокаНДС", ?(Объект.СуммаВключаетНДС, НСтр("ru='В том числе НДС:';en='Including VAT:'"), НСтр("ru='Сумма НДС:'")));
