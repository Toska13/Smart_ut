...
Процедура УправлениеЭлементамиФормы()
	...
	Элементы.ТоварыНомерСтрокиИсходногоСФ.Видимость = ЭтоКорректировочный;
	НастроитьВидимостьРучнойКорректировки(ЭтотОбъект);
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	Для Каждого Строка Из Объект.Товары Цикл
		Строка.ПрослеживаемыйТовар = ЗначениеЗаполнено(Строка.Номенклатура.КодТНВЭД) И Строка.Номенклатура.КодТНВЭД.ПрослеживаемыйТовар;
	КонецЦикла;
