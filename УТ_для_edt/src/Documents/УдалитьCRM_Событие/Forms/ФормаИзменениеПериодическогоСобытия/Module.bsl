...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.СпособИзмененияРяда.СписокВыбора.Добавить("ТолькоТекущее",	НСтр("ru='Только текущее событие';en='Only current event'"));
	Элементы.СпособИзмененияРяда.СписокВыбора.Добавить("ДоКонцаРяда",	НСтр("ru='Это и последующие события';en='It and subsequent events'"));
	Элементы.СпособИзмененияРяда.СписокВыбора.Добавить("ВесьРяд",		НСтр("ru='Все события';en='All events'"));
