...
Процедура ПроверитьРегистрациюОрганизаций()
	...
	ТребуетсяПодключение = БизнесСеть.ОрганизацияНеПодключенаТрубуетсяПовторноеПодключение(Объект.Организация);
	ВидимостьГруппы = Не Объект.Организация.Пустая() И ТребуетсяПодключение;
