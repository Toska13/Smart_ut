...
Процедура УстановитьУсловноеОформление()
	...
	УчетПрослеживаемыхТоваровЛокализация.УстановитьУсловноеОформлениеНомераГТД(ЭтаФорма, "ПереданныеНаКомиссиюКоличествоПоРНПТ");
	...
	УчетПрослеживаемыхТоваровЛокализация.УстановитьУсловноеОформлениеКоличестваПоРНПТ(ЭтаФорма, "СобственныеТоварыКоличествоПоРНПТ");
	УчетПрослеживаемыхТоваровЛокализация.УстановитьУсловноеОформлениеКоличестваПоРНПТ(ЭтаФорма, "ПолученныеНаКомиссиюКоличествоПоРНПТ");
	УчетПрослеживаемыхТоваровЛокализация.УстановитьУсловноеОформлениеКоличестваПоРНПТ(ЭтаФорма, "ПереданныеНаКомиссиюКоличествоПоРНПТ");
...
Процедура ЗаполнитьОстаткамиТоваровНаПустомПомещенииСервер()
	...
	НоменклатураСервер.ЗаполнитьСлужебныеРеквизитыПоНоменклатуреВКоллекции(Объект.Товары,
		СтруктураДействийПоОбновлениюВспомогательныхРеквизитовСтроки(ЭтоОстаткиСобственныхТоваров,
																	ЭтоОстаткиПринятыхНаКомиссиюТоваров,
																	ЭтоОстаткиПереданныхНаКомиссиюТоваров));
...
&НаКлиентеНаСервереБезКонтекста
Функция СтруктураДействийПоОбновлениюВспомогательныхРеквизитовСтроки(ЭтоОстаткиСобственныхТоваров,
																	ЭтоОстаткиПринятыхНаКомиссиюТоваров,
																	ЭтоОстаткиПереданныхНаКомиссиюТоваров)
