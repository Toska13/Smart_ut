...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка)
	...
	|				И НЕ ДанныеДокумента.Договор.ВариантОформленияЗакупок ЕСТЬ NULL
...
Функция ТекстЗапросаТаблицаТоварыОрганизаций(Запрос, ТекстыЗапроса, Регистры)
	...
	|	ВЫБОР
	|		КОГДА ДанныеПоступления.ХозяйственнаяОперация В (ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ЗакупкаВСтранахЕАЭСФактуровкаПоставки),
	|									ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ЗакупкаУПоставщикаФактуровкаПоставки)) ТОГДА
	...
	// Отказ от формирования движения по излишку, сформированному в Поступлении товаров (товары в пути). По месту хранения договор.
	|	И (НЕ ДанныеПоступления.ХозяйственнаяОперация В (ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ЗакупкаВСтранахЕАЭСТоварыВПути),
	...
	|ОБЪЕДИНИТЬ ВСЕ
	|
	// Сторно излишка по пустому номеру ГТД, сформированному в Поступлении товаров (товары в пути). По месту хранения договор.
	|ВЫБРАТЬ
	|	ТаблицаДокумента.НомерСтроки           КАК НомерСтроки,
	|	ЗНАЧЕНИЕ(ВидДвиженияНакопления.Расход) КАК ВидДвижения,
	|	&Период                                КАК Период,
	...
	|	ТаблицаДокумента.Ссылка = &Ссылка
	|	И &ИспользуетсяДокументПоступлениеТоваров
	|	И ДанныеПоступления.ХозяйственнаяОперация В (ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ЗакупкаВСтранахЕАЭСТоварыВПути),
	|									ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ЗакупкаПоИмпортуТоварыВПути),
	|									ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ЗакупкаУПоставщикаТоварыВПути))
	...
	|		И ДанныеПоступления.Склад = АналитикаУчетаНоменклатурыПоСкладам.МестоХранения
	...
	|	ТаблицаДокумента.Ссылка = &Ссылка
	|	И &ИспользуетсяДокументПоступлениеТоваров
	|	И (ДанныеПоступления.ХозяйственнаяОперация В (ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ЗакупкаВСтранахЕАЭСФактуровкаПоставки),
	...
	|ОБЪЕДИНИТЬ ВСЕ
	|
	// Сторно излишка по пустому номеру ГТД, сформированному в Поступлении товаров (товары в пути). По складскому месту хранения.
	|ВЫБРАТЬ
	|	ТаблицаДокумента.НомерСтроки           КАК НомерСтроки,
	|	ЗНАЧЕНИЕ(ВидДвиженияНакопления.Приход) КАК ВидДвижения,
	|	&Период                                КАК Период,
