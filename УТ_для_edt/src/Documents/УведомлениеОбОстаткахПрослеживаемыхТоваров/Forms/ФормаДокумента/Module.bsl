...
Процедура УстановитьДоступностьКомандБуфераОбмена()
	...
	ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементовФормы(Элементы,
																	МассивЭлементов,
																	"Доступность",
																	 НЕ ОбщегоНазначения.ПустойБуферОбмена());
...
Процедура ПересчитатьРеквизитыУведомления()
	...
	Если ТаблицаКоличестваТоваров.Количество() > 0 Тогда
...
Процедура ЗаполнитьПоОстаткамСервер()
	...
	|		И ТоварыОрганизаций.АналитикаУчетаНоменклатуры.Номенклатура.КодТНВЭД = &КодТНВЭД
	|		И ТоварыОрганизаций.АналитикаУчетаНоменклатуры.Номенклатура.ЕдиницаИзмерения = &ЕдиницаИзмерения
	|		И (НЕ ТоварыОрганизаций.НомерГТД.РНПТ)
	|	
	|	ОБЪЕДИНИТЬ ВСЕ
	|	
	|	ВЫБРАТЬ
	...
	|		И РезервыТоваровОрганизаций.АналитикаУчетаНоменклатуры.Номенклатура.КодТНВЭД = &КодТНВЭД
	|		И РезервыТоваровОрганизаций.АналитикаУчетаНоменклатуры.Номенклатура.ЕдиницаИзмерения = &ЕдиницаИзмерения
	|		И (НЕ РезервыТоваровОрганизаций.НомерГТД.РНПТ)
	|	
	|	ОБЪЕДИНИТЬ ВСЕ
	|	
	|	ВЫБРАТЬ
