...
Процедура УстановитьСтатусФискальнойОперации(Форма, Источник) Экспорт
	...
	ЕстьПодключенноеОборудованиеПоОрганизации = Ложь;
	...
	Если ПодключенноеОборудованиеПоОрганизации.ККТ.Количество() Тогда
		ЕстьПодключенноеОборудованиеПоОрганизации = Истина;
	КонецЕсли;
	
	ЕстьПодключенноеОборудованиеПоОрганизацииКредитору = Ложь;
	Если ЗначениеЗаполнено(ОрганизацияКредитор) Тогда
		ПодключенноеОборудованиеПоОрганизацииКредитору = ПодключаемоеОборудованиеУТВызовСервера.ОборудованиеПодключенноеККассеПоОрганизации(ОрганизацияКредитор);
		Если ПодключенноеОборудованиеПоОрганизацииКредитору.ККТ.Количество() Тогда
			ЕстьПодключенноеОборудованиеПоОрганизацииКредитору = Истина;
		КонецЕсли;
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(ОрганизацияКредитор)
		...
		Если ФискальнаяОперацияДанныеЖурнала = Неопределено Тогда
			...
			Если ЕстьПодключенноеОборудованиеПоОрганизации Тогда
	...
	Если ЗначениеЗаполнено(ОрганизацияКредитор)
		...
		Если ФискальнаяОперацияДанныеЖурнала = Неопределено Тогда
			...
			Если ЕстьПодключенноеОборудованиеПоОрганизацииКредитору Тогда		
				МассивПредставлений.Добавить(
						Новый ФорматированнаяСтрока(
							ПредставлениеПробитьЧек,,
							ЦветаСтиля.ЦветГиперссылки,,
...
Функция ПолучитьДанныеПоЗадолженностиПередПоставщикамиДляДляПараметровФискальногоЧека(ДокументСсылка)
	...
	Если ПолучитьФункциональнуюОпцию("НоваяАрхитектураВзаиморасчетов") Тогда
		...
		|	РасчетыСПоставщикамиПоСрокам.ПредоплатаРегл КАК Сумма
		|ИЗ
...
Функция ПолучитьДанныеПоДебиторскойЗадолженностиДляДляПараметровФискальногоЧека(ДокументСсылка, Организация, Контрагент)
...
Функция ПолучитьДанныеПоКредиторскойЗадолженностиДляДляПараметровФискальногоЧека(ДокументСсылка, Организация, Контрагент)
...
Процедура ЗаполнитьШапкуПараметровОперацииФискализацииЧека(ПараметрыФискализацииЧека, ДокументСсылка, Организация, Контрагент, ТипРасчета)
	...
	ПараметрыФискализацииЧека.ТорговыйОбъект = Неопределено;
	ПараметрыФискализацииЧека.МестоРасчетов  = СведенияОбОрганизации.СокращенноеНаименование;
...
Функция ПараметрыОперацииФискализацииЧекаКонтрагентДебитор(ДокументСсылка, ВерсияФФД)
	...
	// Позиции чека
	ТаблицаСуммыВзаимозачетовПоОбъектамРасчетов = ПолучитьДанныеПоДебиторскойЗадолженностиДляДляПараметровФискальногоЧека(ДокументСсылка, Организация, Контрагент);
...
Функция ПараметрыОперацииФискализацииЧекаКонтрагентКредитор(ДокументСсылка, ВерсияФФД)
	...
	// Позиции чека
	ТаблицаСуммыВзаимозачетовПоОбъектамРасчетов = ПолучитьДанныеПоКредиторскойЗадолженностиДляДляПараметровФискальногоЧека(ДокументСсылка, Организация, Контрагент);
