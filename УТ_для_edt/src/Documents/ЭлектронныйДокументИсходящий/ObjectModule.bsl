		...
		Иначе
			...
			Если ТипЗнч(СтруктураРеквизитов) = Тип("Структура") Тогда
				...
				Если ВидЭД = Перечисления.ВидыЭД.ПроизвольныйЭД Тогда
					ТипПроизвольногоДокумента = СоответствиеВидовЭДТипамПроизвольногоДокумента().Получить(СтруктураРеквизитов.ВидЭД);
					Если ЗначениеЗаполнено(ТипПроизвольногоДокумента) Тогда 
						ТипДокумента = ТипПроизвольногоДокумента;
					КонецЕсли;
				КонецЕсли;
...
Процедура ПередУдалением(Отказ)
	...
	ОбменСКонтрагентамиСлужебный.ПередУдалениемЭлектронногоДокумента(Ссылка);
...
Функция СоответствиеВидовЭДТипамПроизвольногоДокумента()

	СоответствиеВидов = Новый Соответствие;
	СоответствиеВидов.Вставить(Перечисления.ВидыЭД.ТОРГ12Продавец, Перечисления.ТипыЭД.ТоварнаяНакладная);
	СоответствиеВидов.Вставить(Перечисления.ВидыЭД.СчетНаОплату, Перечисления.ТипыЭД.СчетНаОплату);
	СоответствиеВидов.Вставить(Перечисления.ВидыЭД.АктВыполненныхРабот, Перечисления.ТипыЭД.АктВыполненныхРабот);
	СоответствиеВидов.Вставить(Перечисления.ВидыЭД.АктИсполнитель, Перечисления.ТипыЭД.АктВыполненныхРабот);

	Возврат СоответствиеВидов;
