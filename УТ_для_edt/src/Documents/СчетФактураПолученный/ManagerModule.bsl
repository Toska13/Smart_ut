...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|				И ДокументыОснованияСчетаФактуры.Ссылка.ДатаЗаписиКнигиПродаж = ДАТАВРЕМЯ(1,1,1)))"
	);
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Пока ВыборкаДокументов.Следующий() Цикл
		...
		Попытка
			...
			Если Не ЗначениеЗаполнено(ДокументОбъект.ДатаЗаписиКнигиПродаж) И ДокументОбъект.Корректировочный Тогда
				ДокументОбъект.ДатаЗаписиКнигиПродаж = ДокументОбъект.Дата;
				ОбъектИзменен = Истина;
			КонецЕсли;
