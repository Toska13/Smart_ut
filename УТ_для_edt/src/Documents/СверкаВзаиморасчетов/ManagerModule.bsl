...
Процедура СвернутьРасчетыПоГруппировкам(ДанныеДокумента, ТаблицаВзаиморасчетов)
	...
	ДетальныеЗаписи.Свернуть("ТипРасчетов, Партнер, ОбъектРасчетов, РасчетныйДокумент, ОписаниеДокумента, ВалютаДокумента", "СуммаДокумента, СуммаДолг, СуммаДолгРегл, СуммаАванс, СуммаАвансРегл");
