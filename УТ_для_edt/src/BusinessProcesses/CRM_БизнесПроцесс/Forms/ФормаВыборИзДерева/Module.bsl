...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		Элементы.ОтборПодразделение.СписокВыбора.Добавить("Подразделение не выбрано", НСтр("ru='Подразделение не выбрано';en='Department not selected'"));
...
Процедура ОтборПодразделениеОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Иначе
		...
		Элементы.ОтборПодразделение.СписокВыбора.Добавить(?(ЗначениеЗаполнено(ТекущееПодразделение), ТекущееПодразделение, "Подразделение не выбрано"), 
			?(ЗначениеЗаполнено(ТекущееПодразделение), НСтр("ru='Мое подразделение (';en='My Department ('") + ТекущееПодразделение + ")", НСтр("ru='Подразделение не выбрано'")));
...
Процедура ОтборПодразделениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	Элементы.ОтборПодразделение.СписокВыбора.Очистить();
	Элементы.ОтборПодразделение.СписокВыбора.Добавить(ПредопределенноеЗначение("Справочник.СтруктураПредприятия.ПустаяСсылка"), НСтр("ru='Все подразделения';en='All Departments'"));
	Элементы.ОтборПодразделение.СписокВыбора.Добавить(?(ЗначениеЗаполнено(ТекущееПодразделение), ТекущееПодразделение, "Подразделение не выбрано"), 
			?(ЗначениеЗаполнено(ТекущееПодразделение), НСтр("ru='Мое подразделение (';en='My Department ('") + ТекущееПодразделение + ")", НСтр("ru='Подразделение не выбрано'")));
