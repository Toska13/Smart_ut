...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ПараметрыОтбора.Вставить("Организация",   ?(ЗначениеЗаполнено(ЭлементОрганизация.Значение), ЭлементОрганизация.Значение, Неопределено));
	ПараметрыОтбора.Вставить("Контрагенты",   ?(ЭлементКонтрагенты.Использование, ЭлементКонтрагенты.Значение, Неопределено));
