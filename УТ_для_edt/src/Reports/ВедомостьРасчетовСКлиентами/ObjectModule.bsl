...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	//++ смарт:ММ #018 184 06.02.2020 Обязательно заполнение Начала периода
	...
	Если НЕ ЗначениеЗаполнено(ПараметрПериод.Значение.ДатаНачала) Тогда
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Не установлено значение параметра ""Начало периода""!");
		Возврат;
	КонецЕсли;
	//-- смарт:ММ 06.02.2020
