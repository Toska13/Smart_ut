...
Процедура ОбновитьРезультат()
	...
	//Если ВоронкаПродаж <> ПредопределенноеЗначение("Справочник.CRM_ВоронкиПродаж.ПоДокументам")  И
	//ЗначениеЗаполнено(ОтборПользователь) Тогда ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(
