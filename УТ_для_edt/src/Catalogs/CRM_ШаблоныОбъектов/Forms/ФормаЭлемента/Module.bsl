...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если Не ЕстьПометки(СписокРеквизитов) Тогда
		...
		Сообщение.Текст = Нстр("ru='Необходимо отметить хотя бы один реквизит!';en='It is necessary to mark at least one attribute!'");
		Сообщение.Сообщить();
	КонецЕсли;
...
"Сделать шаблон общим?';en='Owner of template not specified."
"Make this template common?'");
