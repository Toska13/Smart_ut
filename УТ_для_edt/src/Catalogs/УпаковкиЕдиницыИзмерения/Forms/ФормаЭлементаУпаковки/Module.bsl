...
Процедура ЕдиницаИзмеренияНажатие(ИмяПоля, СтандартнаяОбработка, ТипИзмеряемойВеличины)
	...
	//Смарт {[+](фрагмент ДОБАВЛЕН), Подкин Алексей Иванович 22.12.2020 17:41:11 запрет изменения типа единицы измерения, для однозначной выгрузки в Битрикс управление сайтом.
	Сообщение = Новый СообщениеПользователю;
	Сообщение.Текст = "Выбор единиц измерения, закрыт администратором!";
	Сообщение.Сообщить();
	Возврат;
	//Смарт }Подкин Алексей Иванович 22.12.2020 17:41:11
