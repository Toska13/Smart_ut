...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	Если Не Копирование Тогда
		Отказ = Истина;
		//Смарт {[*](фрагмент ИЗМЕНЕН), Подкин Алексей Иванович 07.09.2021 11:33:48
		ПараметрыФормы = Новый Структура("Предмет, ЗаметкаЛенты", Предмет,Истина);
		//Смарт }Подкин Алексей Иванович 07.09.2021 11:33:48				
