...
Функция ЗапросДанныхКОбработке(МассивСсылокДляОбработки = Неопределено)
	...
	Извещения.Добавить(Перечисления.ТипыЭлементовВерсииЭД.ИП_ПДП_ИП_ЭСФ);
	...
	Извещения.Добавить(Перечисления.ТипыЭлементовВерсииЭД.ИП_ПДП_ИП_УПД_УКД );
...
Функция ПечатнаяФормаЭД(ФайлЭлектронногоДокумента, Идентификатор = Неопределено, ПараметрыПечати = Неопределено)
	...
	ОбменСКонтрагентамиВнутренний.ЗаполнитьОбластьДанныеQRКодаВТабличномДокументе(ТабличныйДокумент);
