...
Процедура УстановитьПараметрыВыбораУчетнойПолитики(ВидОрганизации)
	...
	Если Элементы.УчетнаяПолитика.СписокВыбора.НайтиПоЗначению(УчетнаяПолитикаОрганизаций.УчетнаяПолитика) = Неопределено Тогда
		УчетнаяПолитикаОрганизаций.УчетнаяПолитика = Неопределено;
	КонецЕсли;
