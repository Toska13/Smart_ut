...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//смарт:rnp №355  14.09.2020
	Если Не РольДоступна("ПолныеПрава") Тогда
		Если Не Параметры.ЗначениеКопирования.Пустая() или Не ЗначениеЗаполнено(Объект.Наименование) Тогда
			Отказ = Истина;
			
			Сообщить("Запрещено копировать и создавать партнеров без использования Помощника! Воспользуйтесь кнопкой ""Создать""");
