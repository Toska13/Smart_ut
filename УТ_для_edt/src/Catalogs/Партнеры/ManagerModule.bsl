...
//     * ДругиеКолонки     - Произвольный - Состав колонок соответствует макету "ЗагрузкаИзФайла"
//
...
//     * ДругиеКолонки                - Произвольный - Строки загружаемого файла в соответствии с макетом
...
// +CRM эти процедуры надо перенести в объединенные решения
...
Функция РеквизитыНеРедактируемыеВГрупповойОбработке() Экспорт
 ...
 Результат.Добавить("CRM_ВидыДеятельности.*");
 Возврат Результат;
