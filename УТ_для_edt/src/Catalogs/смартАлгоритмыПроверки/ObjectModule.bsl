...
Процедура ПередЗаписью(Отказ)
	...
	Если Не ЗначениеЗаполнено(ПредставлениеОтбора) 
			И СпособЗаданияУсловия = Перечисления.смартСпособыЗаданияУсловия.КомбинацияИзДругихУсловий Тогда
	...
	ИначеЕсли Не ЗначениеЗаполнено(ПредставлениеОтбора) И 
		СпособЗаданияУсловия = Перечисления.смартСпособыЗаданияУсловия.ВРежимеКонструктора Тогда	
		...
		СхемаКомпоновкиДанных = Справочники.смартАлгоритмыПроверки.ПолучитьМакет(ИмяЗначенияПеречисления);
