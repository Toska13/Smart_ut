...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|	ГДЕ
	|		ДанныеКлассификатора.ЕдиницаИзмерения <> ЗНАЧЕНИЕ(Справочник.УпаковкиЕдиницыИзмерения.ПустаяСсылка)
	|		И (ДанныеОбъекта.ЕдиницаИзмеренияТНВЭД = ЗНАЧЕНИЕ(Справочник.УпаковкиЕдиницыИзмерения.ПустаяСсылка)
	|			ИЛИ ДанныеОбъекта.ЕдиницаИзмеренияТНВЭД <> ДанныеКлассификатора.ЕдиницаИзмерения)";
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|ГДЕ
	|	ДанныеКлассификатора.ЕдиницаИзмерения <> ЗНАЧЕНИЕ(Справочник.УпаковкиЕдиницыИзмерения.ПустаяСсылка)
	|	И (ДанныеНоменклатуры.ЕдиницаИзмеренияТНВЭД = ЗНАЧЕНИЕ(Справочник.УпаковкиЕдиницыИзмерения.ПустаяСсылка)
	|		ИЛИ ДанныеНоменклатуры.ЕдиницаИзмеренияТНВЭД <> ДанныеКлассификатора.ЕдиницаИзмерения)
	|
	|УПОРЯДОЧИТЬ ПО
	|	Ссылка";
