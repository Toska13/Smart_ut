	...
	Если ПустаяСтрока(СтрокаЗаголовка) Тогда
		...
		Если ЗначениеЗаполнено(Свойство) Тогда
			Если НЕ Параметры.РежимВыбора Тогда
				СтрокаЗаголовка = НСтр("ru='Значения свойства %1';en='Property value %1'");
			ИначеЕсли ВыборГрупп Тогда
				СтрокаЗаголовка = НСтр("ru='Выберите группу значений свойства %1';en='Select a value group of property %1'");
			Иначе
				СтрокаЗаголовка = НСтр("ru='Выберите значение свойства %1';en='Select value of property %1'");
			КонецЕсли;
		...
		ИначеЕсли Параметры.РежимВыбора Тогда
			...
			Если ВыборГрупп Тогда
				СтрокаЗаголовка = НСтр("ru='Выберите группу значений свойства';en='Select a value group of property'");
			Иначе
				СтрокаЗаголовка = НСтр("ru='Выберите значение свойства';en='Select property value'");
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
