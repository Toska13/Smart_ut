...
Процедура СтрокаПоискаПриИзменении(Элемент)
	...
	Если СтрокаПоиска <> "" Тогда
		...
		Иначе
			...
			ТекстВопроса = НСтр("ru='Индекс полнотекстового поиска неактуален. Обновить индекс?';en='Full-text search index is invalid. Update the index?'");
...
Процедура УстановитьОтборПоУволенным()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(СписокКонтактныхЛиц,
																			"CRM_Состояние",
																			Перечисления.CRM_Состояние.Уволен,
																			ВидСравненияКомпоновкиДанных.НеРавно,
																			НСтр("ru = 'Уволен'"),
																			НЕ ОтображатьУволенных,
