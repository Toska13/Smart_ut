...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДобавитьДанныеВДеревоНастроекOData("Справочники", 				"Справочник",					ЗначениеДерева, НСтр("ru='Справочники';en='Catalogs'"));
	ДобавитьДанныеВДеревоНастроекOData("Документы", 				"Документ", 					ЗначениеДерева, НСтр("ru='Документы';en='Documents'"));
	ДобавитьДанныеВДеревоНастроекOData("ЖурналыДокументов",			"ЖурналДокументов",				ЗначениеДерева, НСтр("ru='Журналы документов';en='Document journals'"));
	ДобавитьДанныеВДеревоНастроекOData("Перечисления",				"Перечисление",					ЗначениеДерева, НСтр("ru='Перечисления';en='Enumerations'"));
	ДобавитьДанныеВДеревоНастроекOData("ПланыВидовХарактеристик",	"ПланВидовХарактеристик",	 	ЗначениеДерева, НСтр("ru='Планы видов характеристик';en='Chart of characteristics'"));
	ДобавитьДанныеВДеревоНастроекOData("РегистрыСведений", 			"РегистрСведений",	 			ЗначениеДерева, НСтр("ru='Регистры сведений';en='Information registers'"));
	ДобавитьДанныеВДеревоНастроекOData("РегистрыНакопления", 		"РегистрНакопления",	 		ЗначениеДерева, НСтр("ru='Регистры накопления';en='Accumulation registers'"));
	...
	ДобавитьДанныеВДеревоНастроекOData("ПланыОбмена", 				"ПланОбмена",	 				ЗначениеДерева, НСтр("ru='Планы обмена';en='Exchange plans'"));
...
Процедура ПоУмолчаниюНаСервере()
	...
	Массив.Добавить(Метаданные.Справочники.CRM_ПричиныОтклоненияОбращений);
