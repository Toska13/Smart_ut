...
Функция СоздатьИОтправитьУведомлениеНаСервере(ТекущиеДанные, ОтправитьУведомление = Истина)
	...
	Если ТекущиеДанные.ТипУведомления.Имя = "УведомлениеОВвозеПрослеживаемыхТоваров" Тогда
	...
	ИначеЕсли ТекущиеДанные.ТипУведомления.Имя = "УведомлениеОПеремещенииПрослеживаемыхТоваров" Тогда 
