...
Процедура ВладелецПриИзменении(Элемент)
	...
	Для Каждого ЭлементМассива Из МассивКонтактов Цикл
		...
		Если ТекущийСправочник = "Пользователи" Тогда
			...
			Если сфпСоответствиеЛинийИСтатусов <> Неопределено И ЗначениеЗаполнено(НоваяСтрока.ВнутреннийНомер) Тогда
				СтатусЛинии = сфпСоответствиеЛинийИСтатусов.Получить(НоваяСтрока.ВнутреннийНомер);
				НоваяСтрока.Картинка = КартинкаСтатуса(СтатусЛинии);
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;	
