...
Процедура ИзменитьВидимостьДеревоРазделов()
	...
	Элементы.СкрытьПоказатьДеревоРазделов.Заголовок = ?(Элементы.ГруппаДеревоРазделов.Видимость,НСтр("ru='Скрыть разделы';en='Hide sections'"), НСтр("ru='Показать разделы'"));
