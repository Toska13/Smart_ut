...
Процедура ОК(Команда)
    ...
    Если ИспользоватьОграниченияРучныхСкидок Тогда 
		...
		Если ЗначениеЗаполнено(ТекстСообщения) Тогда
            ...
            //++ смарт:Подкин #914 01.03.2022 15:03:54
			Если ВариантПредоставления = 1 И (НЕ смартДоступностьРоли("смартРазрешитьСкидкуБольшеМаксимальной,ПолныеПрава")) Тогда
                
                ПоказатьВопрос(Новый ОписаниеОповещения("смартОКЗавершениеПревышение", ЭтотОбъект), ТекстСообщения + ". ", РежимДиалогаВопрос.ОК); 
                Возврат;	
...
КонецПроцедуры //-- смарт:Подкин #914 01.03.2022 15:16:46
