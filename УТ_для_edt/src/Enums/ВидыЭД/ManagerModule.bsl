...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	ДанныеВыбора.Добавить(Перечисления.ВидыЭД.СведенияОЗакупкеКомиссионером);
	ДанныеВыбора.Добавить(Перечисления.ВидыЭД.СведенияОРеализацииКомиссионером);
	ДанныеВыбора.Добавить(Перечисления.ВидыЭД.КорректировкаСведенийОЗакупкеКомиссионером);
	ДанныеВыбора.Добавить(Перечисления.ВидыЭД.КорректировкаСведенийОРеализацииКомиссионером);
