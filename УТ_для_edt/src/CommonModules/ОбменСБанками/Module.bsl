...
// 
// Параметры:
//  БИКи - Неопределено, Массив из Строка - БИКи, для которых требуется получить информацию
//  Проект - Число, Неопределено - Отбор по проекту, которые должен поддерживать банк.
//     * 1 - Платежные документы.
//     * 2 - Зарплатные документы.
// 
// Возвращаемое значение:
