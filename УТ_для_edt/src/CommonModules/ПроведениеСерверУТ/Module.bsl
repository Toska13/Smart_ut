...
Процедура СообщитьОбОшибкахПроведенияВводОстатковПослеКлиенты(Объект, Отказ, РезультатЗапроса)
	...
	Пока Выборка.Следующий() Цикл
		...
		ТекстСообщения = СтрШаблон(ШаблонСообщения, Выборка.ОбъектРасчетов);
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения, Объект, ,, Отказ);
	КонецЦикла;

КонецПроцедуры

Процедура СообщитьОбОшибкахПроведенияЕстьДвиженияДоКлиенты(Объект, Отказ, РезультатЗапроса)
...
Процедура СообщитьОбОшибкахПроведенияВводОстатковПослеПоставщики(Объект, Отказ, РезультатЗапроса)
...
Процедура СообщитьОбОшибкахПроведенияЕстьДвиженияДоПоставщики(Объект, Отказ, РезультатЗапроса)
...
Процедура СообщитьОбОшибкахПроведенияПоРегиструТоварыКОформлениюДокументовИмпорта(Объект, Отказ, РезультатЗапроса)
