...
Процедура ПереопределитьПараметрыСеанса(УстановленныеПараметры, Знач ИменаПараметровСеанса) Экспорт
	...
	// +CRM
	CRM_ЛицензированиеЭкспортныеМетоды.ПереопределитьПараметрыСеанса(УстановленныеПараметры, ИменаПараметровСеанса);
	// -CRM
...
Процедура ПереопределитьСерииКлючейКонфигурации(СерииКлючейКонфигурации, Знач Активные = Истина)	Экспорт
	...
	// +CRM
	CRM_ЛицензированиеЭкспортныеМетоды.ПереопределитьСерииКлючейКонфигурации(СерииКлючейКонфигурации);
