...
Функция ИсключитьИзТаблицыСловНезначимые(ТаблицаСлов, ТипОбъекта, Знач ИсключитьНезначимыеСловаИБ = Истина, Знач ПроверитьИзменениеСлов = Ложь)
	...
	Запрос.Текст = ТекстЗапросаПроверкиСловПоСтатистикиИспользованияВСловаре(ПроверитьИзменениеСлов,
																			ПолеГруппировки,
...
Функция ТекстЗапросаПроверкиСловПоСтатистикиИспользованияВСловаре(Знач ПроверитьИзменениеСлов, Знач ПолеГруппировки,
	...
	Если ПроверитьИзменениеСлов И ПолеГруппировки = "СсылкаНаОбъект" Тогда
		...
		Если ОбъектыГруппировки.Количество() = 1 Тогда
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&ИндексированиеТаблицы", "");
		Иначе
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&ИндексированиеТаблицы", "
				|ИНДЕКСИРОВАТЬ ПО
		...
		|	И СловарьСопоставленияНоменклатурыБЭД.Позиция > 0
		|	И СловарьСопоставленияНоменклатурыБЭД.СсылкаНаОбъект В(&ОбъектыГруппировки)
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
