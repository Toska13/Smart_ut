...
Процедура ВключитьПоддержкуВидовПродукцииИС(Контекст, ПараметрыСканирования, ВидПродукции) Экспорт
	...
	ИначеЕсли ШтрихкодированиеИСКлиентСервер.ЭтоКонтекстОбъекта(Контекст, "Документ.ПоступлениеБезналичныхДенежныхСредств") Тогда
		
		ЗаполнитьПараметрыСканированияПоступлениеБезналичныхДенежныхСредств(ПараметрыСканирования, Контекст, ВидПродукции);
		
	ИначеЕсли ШтрихкодированиеИСКлиентСервер.ЭтоКонтекстОбъекта(Контекст, "Документ.СписаниеБезналичныхДенежныхСредств") Тогда
		
		ЗаполнитьПараметрыСканированияСписаниеБезналичныхДенежныхСредств(ПараметрыСканирования, Контекст, ВидПродукции);
...
Процедура ЗаполнитьПараметрыСканированияПоступлениеБезналичныхДенежныхСредств(ПараметрыСканирования, Контекст, ВидПродукции)
...
Процедура ЗаполнитьПараметрыСканированияСписаниеБезналичныхДенежныхСредств(ПараметрыСканирования, Контекст, ВидПродукции)
...
Процедура ЗаполнитьПараметрыСканированияОперацияПоПлатежнойКарте(ПараметрыСканирования, Контекст, ВидПродукции)
	...
	ВключенаПоддеркаИСМП = Ложь;
	
	Если Контекст.Объект.ХозяйственнаяОперация = ПоступлениеОплатыОтКлиента Тогда
		ВключенаПоддеркаИСМП = ШтрихкодированиеИСМПКлиентСервер.ЗаполнитьПараметрыСканированияДокументаРозничнойПродажи(ПараметрыСканирования, ВидПродукции);
	ИначеЕсли Контекст.Объект.ХозяйственнаяОперация = ВозвратОплатыКлиенту Тогда
		ВключенаПоддеркаИСМП = ШтрихкодированиеИСМПКлиентСервер.ЗаполнитьПараметрыСканированияДокументаРозничногоВозврата(ПараметрыСканирования, ВидПродукции);
	Иначе
		Возврат;
	КонецЕсли;
	
	Если ВключенаПоддеркаИСМП Тогда
		ЗаполнитьККТФФД12(ПараметрыСканирования, Контекст);
	КонецЕсли;
