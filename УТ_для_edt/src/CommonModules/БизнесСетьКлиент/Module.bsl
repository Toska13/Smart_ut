...
Функция ОрганизацияНеПодключенаТрубуетсяПовторноеПодключение(Организация) Экспорт
	Возврат БизнесСетьВызовСервера.ОрганизацияНеПодключенаТрубуетсяПовторноеПодключение(Организация);
КонецФункции
...
Процедура ОткрытьФормуПодключенияОрганизацииСПроверкойПодключения(
	...
	Если ОрганизацияНеПодключенаТрубуетсяПовторноеПодключение(Организация) Тогда
		Результат = Истина;
