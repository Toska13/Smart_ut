...
// Функция возвращает первое найденное распоряжение к оформлению уведомления о ввозе прослеживаемых товаров для заданного первичного документа.
//
// Параметры:
...
Функция РаспоряжениеКОФормлениюУведомленияОВвозеПрослеживаемыхТоваровПоОснованию(ПервичныйДокумент) Экспорт
	...
	ТаблицаРаспоряжений = Документы.УведомлениеОВвозеПрослеживаемыхТоваров.РаспоряженияКОформлениюУведомленийОВвозеПоОснованию(ПервичныйДокумент);
...
// Функция возвращает первое найденное уведомление о ввозе прослеживаемых товаров заданного первичного документа.
//
// Параметры:
//	ПервичныйДокумент - ДокументСсылка - Документ, для которого необходимо найти уведомления о ввозе прослеживаемых товаров.
//	Проведен - Булево - Признак того, что необходимо получить проведенные документы.
//
// Возвращаемое значение:
//	Неопределено, ДокументСсылка - Ссылка на документ уведомление о ввозе прослеживаемых товаров. Если не найден, тогда Неопределено
//
Функция УведомлениеОВвозеПрослеживаемыхТоваровПоОснованию(ПервичныйДокумент, Проведен = Истина) Экспорт
	
	Результат = Неопределено;
	
	ТаблицаУведомленийОВвозе = Документы.УведомлениеОВвозеПрослеживаемыхТоваров.УведомленияОВвозеПрослеживаемыхТоваровПоОснованию(ПервичныйДокумент, Проведен);
