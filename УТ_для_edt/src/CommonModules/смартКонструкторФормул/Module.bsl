...
Процедура ДобавитьСписокПолейНаФорму(Форма, Параметры) Экспорт
	...
	смартКонструкторФормулСлужебный.ДобавитьСписокПолейНаФорму(Форма, Параметры);
...
Функция ПараметрыДобавленияСпискаПолей() Экспорт
	...
	Возврат смартКонструкторФормулСлужебный.ПараметрыДобавленияСпискаПолей();
...
Функция ТаблицаПолей() Экспорт
	...
	Возврат смартКонструкторФормулСлужебный.ТаблицаПолей();
...
Функция ДеревоПолей() Экспорт
	...
	Возврат смартКонструкторФормулСлужебный.ДеревоПолей();
...
Функция КоллекцияПолей(ИсточникПолей, Знач ИмяКоллекцииСКД = Неопределено) Экспорт
	...
	Возврат смартКонструкторФормулСлужебный.КоллекцияПолей(ИсточникПолей, , ИмяКоллекцииСКД);
...
Процедура ОбновитьКоллекцииПолей(Форма, КоллекцииПолей, ИмяСпискаПолей = "ДоступныеПоля") Экспорт
	...
	смартКонструкторФормулСлужебный.ОбновитьКоллекцииПолей(Форма, КоллекцииПолей, ИмяСпискаПолей);
...
Процедура ЗаполнитьСписокДоступныхПолей(Форма, ПараметрыЗаполнения) Экспорт
	...
	смартКонструкторФормулСлужебный.ЗаполнитьСписокДоступныхПолей(Форма, ПараметрыЗаполнения);
...
Процедура ВыполнитьПоискВСпискеПолей(Форма) Экспорт
	...
	смартКонструкторФормулСлужебный.ВыполнитьПоискВСпискеПолей(Форма);
...
Процедура ОбработчикКонструктораФормул(Форма, Параметр, ДополнительныеПараметры) Экспорт
	смартКонструкторФормулСлужебный.ОбработчикКонструктораФормул(Форма, Параметр, ДополнительныеПараметры);
КонецПроцедуры
...
Функция СписокОператоров(ГруппыОператоров = Неопределено) Экспорт
	...
	Возврат смартКонструкторФормулСлужебный.СписокОператоров(ГруппыОператоров);
...
Функция ПредставлениеФормулы(ПараметрыФормулы) Экспорт
	...
	ИсточникДоступныхПолей.КоллекцияПолей = смартКонструкторФормулСлужебный.КоллекцияПолей(ПараметрыФормулы.Операнды);
	...
	ИсточникиДоступныхПолей = смартКонструкторФормулСлужебный.КоллекцияИсточниковДоступныхПолей();
	ИсточникДоступныхПолей = ИсточникиДоступныхПолей.Добавить(); 
	ИсточникДоступныхПолей.КоллекцияПолей = смартКонструкторФормулСлужебный.КоллекцияПолей(ПараметрыФормулы.Операторы);
	
	ОписаниеСпискаПолей = ОписаниеСписковПолей.Добавить();
	ОписаниеСпискаПолей.ИсточникиДоступныхПолей = ИсточникиДоступныхПолей;
	
	Возврат смартКонструкторФормулСлужебный.ПредставлениеВыражения(ПараметрыФормулы.Формула, ОписаниеСписковПолей);
...
Функция ПредставлениеФормулыПоДаннымФормы(Форма, Формула) Экспорт
	...
	Возврат смартКонструкторФормулСлужебный.ПредставлениеФормулы(Форма, Формула);
...
Функция ПараметрыРедактированияФормулы() Экспорт
	...
	Возврат смартКонструкторФормулКлиентСервер.ПараметрыРедактированияФормулы();
...
Функция ФормулаИзПредставления(Форма, ПредставлениеФормулы) Экспорт
	...
	Возврат смартКонструкторФормулСлужебный.ФормулаИзПредставления(Форма, ПредставлениеФормулы);
