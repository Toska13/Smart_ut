	...
	Для Каждого ИмяРеквизита Из МассивРеквизитов Цикл
		...
		Если СПрефиксом И ИмяРеквизита = "НомерСчета" Тогда
			...
			НаименованиеРасчетногоСчета = 
				?(ДенежныеСредстваКлиентСервер.ЭтоКазначейскийСчет(ЗначениеРеквизита),
					"казн.счет",
					"р/с");
			
			НаименованиеБИК = 
				?(ДенежныеСредстваКлиентСервер.ЭтоБИКТОФК(ДополнительныеРеквизиты.БИК),
					"БИК ТОФК",
					"БИК");
					
			НаименованиеКоррСчета = 
				?(ДенежныеСредстваКлиентСервер.ЭтоЕдиныйКазначейскийСчет(ДополнительныеРеквизиты.КоррСчет),
					"ЕКС",
					"к/с");
...
Процедура ЗаполнитьДанныеСтруктурыПолучателяПоТипуОбъекта(ПолноеИмяОбъектаМетаданных , СтруктураДанныхОбъектаПечати) Экспорт
	...
	Если ПолноеИмяОбъектаМетаданных = "Справочник.Партнеры"
		Или ПолноеИмяОбъектаМетаданных = "Справочник.ПретензииКлиентов"
