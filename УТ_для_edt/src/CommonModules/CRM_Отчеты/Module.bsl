...
//   Картинка - образец отчета или Неопределено в случае его отсутствия.
//
...
"ИмяОтчета = ""%1"", КлючВарианта = ""%2"".';en='Failed to define report variant by passed parameters:"
...
// Параметры:
//   ВариантыОформления - Соответствие - Описания предопределенных вариантов оформления в разрезе полей
//   Поля - Строка, Массив из Строка - Имена суммовых полей
...
// Параметры:
//   ВариантыОформления - Соответствие - Описания предопределенных вариантов оформления в разрезе полей
//   Поля - Строка, Массив из Строка - Имена количественных полей
//   НастройкиКД - НастройкиКомпоновкиДанных - Настройки компоновки данных отчета для установки основного варианта оформления
//
...
//
// Возвращаемое значение: 
//  Структура     - Структура сложебных данных для формирования. Поля:
//   * НастройкиОтчета - НастройкиКомпоновкиДанных - Настройки компоновки данных отчета.
...
Процедура СтандартизироватьСхему(СхемаКомпоновкиДанных) Экспорт
	...
	ДобавитьСтрокуТаблицыПолей(ТабПолей, "ПериодДекада", НСтр("ru='Начало недели';en='Beginning of week'"), НСтр("ru='ДФ=дд.ММ.гггг'"));
...
//
// Возвращаемое значение: 
//  Массив из Цвет - содержит элементы типа Цвет
//
...
//	 Если поле не найдено, возвращает Неопределено.
//
...
// Возвращает количество фиксированных слева строк.
//
// Параметры:
//	КомпоновщикНастроек - КомпоновщикНастроек - Компоновщик настроек.
//
// Возвращаемое значение:
//	Число - количество фиксированных слева строк.
...
//
// Параметры:
//	Стр			- Структура - структура параметров.
//	Отображение - ОтображениеОбычнойГруппы - Отображение.
...
//	ЭтаФорма			  - ФормаКлиентскогоПриложения - Форма.
//	Элементы			  - ЭлементыФормы - коллекция элементов формы.
//	ПараметрыВыбора		  - ПараметрыВыбора - Параметры выбора.
//	СвязиПараметровВыбора - СвязиПараметровВыбора - Связи параметров выбора.
//
...
// Добавить символ валюты к заголовкам полей.
//
// Параметры:
