...
Процедура ДополнитьСвойстваЗапроса(Запрос, ПараметрыРасчета) Экспорт
	...
	УчетныеПолитики = ПараметрыРасчета.УчетныеПолитикиКэш;
	УчетныеПолитикиПрошлогоПериода = ПараметрыРасчета.УчетныеПолитикиПрошлогоПериодаКэш;
	...
	Запрос.УстановитьПараметр("ДатаВозможностиВычетаПриОказанииУслугНеВРФ",          ПараметрыРасчета.НастройкиУчетаНДС.ДатаВозможностиВычетаПриОказанииУслугНеВРФ);
