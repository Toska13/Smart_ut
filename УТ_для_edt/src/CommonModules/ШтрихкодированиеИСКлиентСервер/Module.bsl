...
// * УпрощеннаяОбработкаКодовМаркировки - Булево - упрощенная обработка кодов маркировки при загрузке кодов в отчет производственой линии.
...
Функция БазовыеПараметрыСканирования() Экспорт
	...
	БазовыеПараметры.Вставить("УпрощеннаяОбработкаКодовМаркировки", Ложь);
...
Функция ВидыУпаковокДляПередачиОтчетаОНанесении() Экспорт
	...
	// Для АТП может быть не заполнен вид упаковки, если не удалось определить шаблон
	Результат.Вставить(ПредопределенноеЗначение("Перечисление.ВидыУпаковокИС.ПустаяСсылка"),    Истина);
