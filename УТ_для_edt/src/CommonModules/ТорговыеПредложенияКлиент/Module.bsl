...
Процедура ОповеститьОбИзмененииКорзины(АдресДанныхКорзины, Источник) Экспорт
	...
	Если Не ЗначениеЗаполнено(АдресДанныхКорзины) Тогда
		Возврат;
	КонецЕсли;	
...
//
Процедура ПолучитьХарактеристикиКатегорииВФоне(ИдентификаторКатегории, Форма, 
	ОповещениеОЗавершении, ИдентификаторЗадания) Экспорт
	
	УникальныйИдентификатор = Форма.УникальныйИдентификатор;

	ДлительнаяОперация = ТорговыеПредложенияВызовСервера.ПолучитьХарактеристикиКатегорииВФоне(
		ИдентификаторКатегории, УникальныйИдентификатор, ИдентификаторЗадания);
