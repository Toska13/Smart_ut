...
Функция ДанныеДокументаСоответствуютДаннымУпаковок(ПроверяемыйДокумент) Экспорт
	...
	ВидыПродукции = ИнтеграцияИСМПВызовСервера.УчитываемыеВидыМаркируемойПродукции(НачалоДня(ПроверяемыйДокумент.Дата), Ложь);
...
Процедура ЗаполнитьРасхожденияКодовМаркировкиУКД(ШтрихкодыУпаковокДо, ШтрихкодыУпаковок) Экспорт
	...
	СписокЗапросов.Добавить(
		...
		|			И втШтрихкодыУпаковок.Штрихкод = втШтрихкодыУпаковокДо.Штрихкод
	...
	СписокЗапросов.Добавить(
		...
		|			И втШтрихкодыУпаковокДо.Штрихкод = втШтрихкодыУпаковок.Штрихкод
