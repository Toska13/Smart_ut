...
Функция ТекстЗапросаПоТаблицеТоваровУведомленияОбОстатках() Экспорт
	...
	ТекстЗапроса =
		"ВЫБРАТЬ
		|	ВЫРАЗИТЬ(УведомлениеОбОстатках.КодТНВЭД КАК Справочник.КлассификаторТНВЭД).НаименованиеПолное КАК НаимТовДок,
		|	ВЫБОР
		...
		|ИЗ
		|	Документ.УведомлениеОбОстаткахПрослеживаемыхТоваров КАК УведомлениеОбОстатках
		|ГДЕ
