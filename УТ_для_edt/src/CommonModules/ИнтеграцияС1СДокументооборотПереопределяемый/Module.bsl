...
Процедура ПриЗаполненииСвойстваОбъектаXDTOПоЗначению(Значение, Свойства, ТипОбъекта, ИмяСвойства, ТипСвойства,
	...
	ИначеЕсли ТипСвойства = "DMVATRate"
		...
		ИначеЕсли Значение = Перечисления.СтавкиНДС.НДС10 Или Значение = Перечисления.СтавкиНДС.НДС10_110 Тогда
			СтавкаНДС = "10%";
			СтавкаНДСID = "НДС10";
			
		ИначеЕсли Значение = Перечисления.СтавкиНДС.НДС18 Или Значение = Перечисления.СтавкиНДС.НДС18_118 Тогда
			СтавкаНДС = "18%";
			СтавкаНДСID = "НДС18";
			
		ИначеЕсли Значение = Перечисления.СтавкиНДС.НДС20 Или Значение = Перечисления.СтавкиНДС.НДС20_120 Тогда
			СтавкаНДС = "20%";
			СтавкаНДСID = "НДС20";
