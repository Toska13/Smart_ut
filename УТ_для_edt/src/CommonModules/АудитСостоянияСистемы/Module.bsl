...
//
Функция НайтиПроверкуПоКлючевымПолям(КонтекстВыполнения, Идентификатор, ВозвращатьТолькоСсылку = Истина, ЗаполнятьПроверкиЕслиНеНайдена = Истина) Экспорт
	...
	Если ЗаполнятьПроверкиЕслиНеНайдена Тогда
		...
		Возврат НайтиПроверкуПоКлючевымПолям(КонтекстВыполнения, Идентификатор, ВозвращатьТолькоСсылку, Ложь);
...
Функция ЗарегистрироватьГруппуПроверокСостоянияСистемы(Описание, СуществующиеПроверки, РежимОбновленияПроверок = Ложь)
	...
	Попытка
		...
		ГруппаПроверок = НайтиПроверкуПоКлючевымПолям(Описание.КонтекстВыполнения, Описание.Идентификатор,, Ложь);
		...
		Иначе
			...
			ГруппаОбъект.Родитель = НайтиПроверкуПоКлючевымПолям(Описание.КонтекстВыполнения, Описание.ИдентификаторРодителя,, Ложь);
...
Функция ЗарегистрироватьПроверкуСостоянияСистемы(Описание, СуществующиеПроверки, РежимОбновленияПроверок = Ложь)
	...
	Попытка
		...
		Проверка = НайтиПроверкуПоКлючевымПолям(Описание.КонтекстВыполнения, Описание.Идентификатор,, Ложь);
		...
		Иначе
			...
			ПроверкаОбъект.Родитель = НайтиПроверкуПоКлючевымПолям(Описание.КонтекстВыполнения, Описание.ИдентификаторРодителя,, Ложь);
