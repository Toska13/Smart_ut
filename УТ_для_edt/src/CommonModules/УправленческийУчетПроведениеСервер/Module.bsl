...
Функция ТекстЗапросаРасчетыСПартнерами()
	...
	#Область ТекстЗапросаПоРасчетамСПартнерамиПоСрокам
		...
		|	КлючиАналитики.Организация КАК Организация,
		|	КлючиАналитики.Организация.ГоловнаяОрганизация КАК ГоловнаяОрганизация,
		|	РасчетыСПоставщиками.ОбъектРасчетов.Организация КАК ОрганизацияОбъектаРасчетов,
		...
		|	КлючиАналитики.Организация КАК Организация,
		|	КлючиАналитики.Организация.ГоловнаяОрганизация КАК ГоловнаяОрганизация,
		|	РасчетыСКлиентами.ОбъектРасчетов.Организация КАК ОрганизацияОбъектаРасчетов,
		|	КлючиАналитики.НаправлениеДеятельности,
		|	КлючиАналитики.Партнер,
		|	КлючиАналитики.Контрагент КАК Контрагент,
		|	КлючиАналитики.Договор КАК Договор,
	...
	#Область ТекстЗапросаПоРасчетамСПартнерамиПоДокументам
		...
		|	КлючиАналитики.Организация КАК Организация,
		|	КлючиАналитики.Организация.ГоловнаяОрганизация КАК ГоловнаяОрганизация,
		|	РасчетыСПоставщиками.ЗаказПоставщику.Организация КАК ОрганизацияОбъектаРасчетов,
		|	КлючиАналитики.НаправлениеДеятельности КАК НаправлениеДеятельности,
		|	КлючиАналитики.Партнер,
		|	КлючиАналитики.Контрагент КАК Контрагент,
		|	КлючиАналитики.Договор КАК Договор,
		...
		|	КлючиАналитики.Организация КАК Организация,
		|	КлючиАналитики.Организация.ГоловнаяОрганизация КАК ГоловнаяОрганизация,
		|	РасчетыСКлиентами.ЗаказКлиента.Организация КАК ОрганизацияОбъектаРасчетов,
		|	КлючиАналитики.НаправлениеДеятельности,
		|	КлючиАналитики.Партнер,
		|	КлючиАналитики.Контрагент КАК Контрагент,
		|	КлючиАналитики.Договор КАК Договор,
...
//Платежные документы: ПоступлениеБДС, ПКО
		...
		|		И ВозвратОплаты.Ссылка ЕСТЬ NULL)
		|	ИЛИ (РасчетыСПартнерами.Организация <> РасчетыСПартнерами.ОрганизацияОбъектаРасчетов
		|		И НЕ ВозвратОплаты.Ссылка ЕСТЬ NULL)
		|";
		#КонецОбласти
...
//Возврат оплаты по курсу аванса: СписаниеБДС, РКО
		...
		|	РасчетыСПартнерами.ГоловнаяОрганизация КАК ВладелецОбъектаРасчета,
		|	РасчетыСПартнерами.НаправлениеДеятельности КАК КорНаправлениеДеятельности,
		|	РасчетыСПартнерами.Партнер КАК КорПартнер,
		|	РасчетыСПартнерами.Контрагент КАК КорКонтрагент,
		|	РасчетыСПартнерами.Договор КАК КорДоговор,
