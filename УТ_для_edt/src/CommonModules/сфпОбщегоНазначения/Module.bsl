...
Функция сфпЗначенияРеквизитовОбъекта(Ссылка, Знач Реквизиты) Экспорт
	...
	ИначеЕсли ТипЗнч(Реквизиты) = Тип("Массив") Или ТипЗнч(Реквизиты) = Тип("ФиксированныйМассив") Тогда
		...
		КонецЦикла;
	Иначе
		ВызватьИсключение сфпПодставитьПараметрыВСтроку(НСтр("ru='Неверный тип второго параметра Реквизиты: %1';en='Incorrect type of the second parameter Attributes: %1'"), Строка(ТипЗнч(Реквизиты)));
	КонецЕсли;
...
"в процедуре СкопироватьСвойстваПользователяИБ общего модуля Пользователи.';en='Invalid value of the Приемник or Источник parameter"
