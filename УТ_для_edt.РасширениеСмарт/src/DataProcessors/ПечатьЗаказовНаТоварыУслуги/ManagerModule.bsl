...
Процедура смарт_Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода)
	...
	#Вставка
	//++ #Б-1810 смарт: Фролов 28.01.2025 //Создать новую печатную форму документа "Акт фактического использования оборудования"
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "АктОФактическомИспользованииОборудования") Тогда

		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
		КоллекцияПечатныхФорм,
		"АктОФактическомИспользованииОборудования",
		НСтр("ru = 'Акт о фактическом использовании оборудования'"),
		СформироватьПечатнуюФормуЗаказаКлиента(СтруктураТипов, ОбъектыПечати, ПараметрыПечати));
...
&ИзменениеИКонтроль("ЗаполнитьТабличныйДокументЗаказаНаТоварыУслуги")
//++ #Б-1810 смарт: Фролов 28.01.2025 //Создать новую печатную форму документа "Акт фактического использования оборудования"
Процедура смарт_ЗаполнитьТабличныйДокументЗаказаНаТоварыУслуги(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати, ИмяМакета)
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		#Удаление //++ #Б-1810 смарт: Фролов 28.01.2025 //Создать новую печатную форму документа "Акт фактического использования оборудования"
		// ШАПКА - ИСПОЛНИТЕЛЬ
		...
		#Вставка
		//++ #Б-1810 смарт: Фролов 28.01.2025 //Создать новую печатную форму документа "Акт фактического использования оборудования"
		Если ДанныеПечати.ПредставлениеДокумента = "Акт о фактическом использовании оборудования" Тогда
			
			// ШАПКА - АРЕНДОДАТЕЛЬ

			ОбластьМакета = Макет.ПолучитьОбласть("Арендодатель");
			УстановитьПараметр(ОбластьМакета, "ПредставлениеАрендодателя", ОписаниеОрганизации(ДанныеПечати, "Исполнитель"));
			ТабличныйДокумент.Вывести(ОбластьМакета);

			// ШАПКА - АРЕНДАТОР

			ОбластьМакета = Макет.ПолучитьОбласть("Арендатор");
			УстановитьПараметр(ОбластьМакета, "ПредставлениеАрендатора", ОписаниеОрганизации(ДанныеПечати, "Заказчик"));
			ТабличныйДокумент.Вывести(ОбластьМакета);
		...
		#Вставка
		//++ #Б-1810 смарт: Фролов 28.01.2025 //Создать новую печатную форму документа "Акт фактического использования оборудования"
		Если НЕ ДанныеПечати.ПредставлениеДокумента = "Акт о фактическом использовании оборудования" Тогда
		...
		Если ДанныеПечати.ПредставлениеДокумента = "Акт о фактическом использовании оборудования" Тогда
			...
			ОбластьМакета = Макет.ПолучитьОбласть("ПодвалАкта");
			ТабличныйДокумент.Вывести(ОбластьМакета);
