...
Функция смарт_ТабличныйДокументКарточкиНоменклатуры(Номенклатура, НастройкиВидимостиИЗаголовков)
	...
	Если ГлаваВидна("ОсновныеПараметрыУчета", СтруктураВидимости) Тогда 
		...
		СтрокасмартКлассификацияНоменклатуры = НСтр("ru = '<не указано>'");
		Если ЗначениеЗаполнено(Объект.смартКлассификацияНоменклатуры) Тогда
			СтрокасмартКлассификацияНоменклатуры = Объект.смартКлассификацияНоменклатуры;
		КонецЕсли;
		ВывестиРазделСУчетомРазмераЗначений(ТабличныйДокументПраво, Макет, "смартКлассификацияНоменклатуры", СтрокасмартКлассификацияНоменклатуры);
